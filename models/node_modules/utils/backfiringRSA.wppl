...
var backfireHypothesis = function(alpha, priorParameters){
	...
	var speaker1 = cache(function(action, event_probability) {
	  Enumerate(function(){
	...
	var listener1 = function(utterance) {
	  Enumerate(function(){
	    ...
	    var S1 = speaker1(action, event_probability)
	...
	// return speaker1(true, 0.8)
	// return listener0("say nothing", 0.5)
}
...
var literalBayesianHypothesis = function(priorParameters){
