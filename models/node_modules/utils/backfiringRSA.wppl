...
var literalBayesian = function(utterance, priorParameters, baseline, logistic_parameters) {
  Enumerate(function(){

  var habit_prior = priorParameters.habit_prior
  // var habit_strength = priorBins[discrete(habit_prior)]
  var habit_strength = sample(habit_prior)
  var event_probability = logistic(habit_strength, logistic_parameters)
...
var continuous_listener1 = function(utterance, priorParameters, alpha, logistic_parameters) {
  Enumerate(function(){

  var habit_prior = priorParameters.habit_prior
  // var habit_strength = priorBins[discrete(habit_prior)]
  var habit_strength = sample(habit_prior)
  // var habit_strength = sample(priorBins[discrete(habit_prior)])
  var event_probability = logistic(habit_strength, logistic_parameters)
  // var lambda_backoff = priorParameters.lambda_backoff
  // var lambda_habit = priorParameters.lambda_habit
  var cost = priorParameters.cost
