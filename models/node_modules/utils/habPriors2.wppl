...
var data = mht.readCSV(fpath+"minimal-1-pilot.csv").data
var df = dataFrame(data, ["rounded_normed_logfreq"])



var df_e0 = subset(dataFrame(existData, ["val"]), "gender", "female")
...
var df_w0 = subset(dataFrame(waitData, ["val"]), "gender", "female")
	...
	foreach(items, function(i){
		...
		// 	foreach(genders, function(g){
				...
				// 	var genderData_w = subset(df_w, "gender", g)
					...
					query.add([i,"habit_strength"], {gamma: gamma_2, delta:delta_2})
