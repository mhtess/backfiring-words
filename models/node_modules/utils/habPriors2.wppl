...
var data = mht.readCSV(fpath+"data-and-priorq2-sans-hats.csv").data
var df = dataFrame(data, ["logdayprob","round_logdayprob"])

var df_baseline = subset(df, "condition", "baseline")
var df_observation = subset(df, "condition", "observation")
var df_backfire = subset(df, "condition", "communication")


var df_w = subset(df, "condition", "prior")
...
var items = _.uniq(_.pluck(df_baseline, "item"))

var genders = _.uniq(_.pluck(df_baseline, "gender"))
