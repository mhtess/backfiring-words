...
The human capacity to generalize from examples is the foundation for learning about the world; children as young as X, for instance, use this kind of inductive reasoning to infer  people's preferences and reliability, so that they can predict others' behavior and identify trustworthy people \red{(CITE)}.
This capacity to generalize can be augmented with testimony from others \red{cite testimony}.
