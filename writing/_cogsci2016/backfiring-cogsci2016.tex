...
\ndg{i think the model section can be revised in a more streamlined way: here's observation, here's interpretation without presupposition, here's backfiring. the only thing is... i'm not sure which middle model is actually appropriate to the data we have.}
