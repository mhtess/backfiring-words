...
The posterior predictive distribution as compared to the human elicited frequencies are shown in Figure \ref{fig:expt2model} (left). 
Overall, the model explains much of the variance in the human data $r^2(81) =0.86$.
The model does the worst job capturing the \emph{Baseline} condition: Among the Communicative and Observational conditions, the model explains almost all of the variance predicts the data well: $r^2(54) = 0.96$.
Though almost all of the variance is captured, the effects of backfiring are subtle as compared to the baseline frequency (Figure \ref{fig:expt2model} right), though the communicative condition consistently provides less information than the observational condition.
