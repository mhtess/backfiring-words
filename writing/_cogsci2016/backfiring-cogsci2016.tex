...
Our experiments serve as conceptual replications of previous work (CITE) demonstrating that adults try to avoid redundancy in conversation by adjusting information that is in common ground between interlocutors.  Ultimately, this can result in an utterance ``backfiring", or implying that the content expressed is typically not true.  If a person notes, ``My roommate washed her dishes today," for example, then a listener who does not know the roommate will likely infer that the roommate does \emph{not} typically was her dishes; otherwise, the utterance would not be informative.
