...
In 1973, beleaguered U.S. President Richard Nixon declared to the press corps, ``I am not a crook'' (CITE).  
...
The model derives predictions by revising common ground between interlocutors so that a speaker's utterance is always informative.  After hearing, ``My roommate washed her dishes," for example, the model predicts that a person who does not know the roommate should infer that the roommate does \emph{not} typically wash her dishes.
