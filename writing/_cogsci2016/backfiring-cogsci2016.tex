...
In the present study, we directly test these predictions.  In Experiment 1, we conceptually replicate previous findings that adults try to avoid semantic redundancy in conversation by adjusting information that is in common ground between speakers.  We also show that \red{something about when common ground is aligned}.  In Experiment 2, we show that \red{the strength of the backfiring effect varies according to the strength of the redundant preexisting beliefs}.
