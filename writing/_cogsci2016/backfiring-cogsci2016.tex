...
The human capacity to generalize from examples such as these is the foundation for learning about the world's categories \cite{Markman1989} and people \cite<e.g.>{Seiver2013}. 
...
We need not observe the roommate wash her dishes to infer that she might often do so, but rather can be told by a reliable speaker that the roommate has this habit \cite<e.g.>{Gelman1999}.
