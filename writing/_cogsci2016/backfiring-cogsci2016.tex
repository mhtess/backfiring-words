...
%Thus, upon hearing Nixon state, ``I am not a crook," a listener unaware of any scandals surrounding Nixon may adjust the information in common ground to include an accusation that Nixon \emph{was} involved in criminal activity.  
One important prediction of this theory, then, is that this backfiring effect should disappear if the listener's uncertainty about what is in common ground is made explicit.  If, for instance, an official needed to know whether Nixon was a crook as part of a background check for serving as President, and Nixon replied, ``No, I am not a crook," then the utterance is established as semantically informative for the listener.  As a result, it no longer presupposes any accusation against Nixon.  Another important prediction is that the strength of the backfiring effect should vary according to the strength of the preexisting beliefs that are redundant with the utterance.  The more strongly one believes that people by default are not crooks, for example, the less informative the statement, ``I am not a crook," should be.

In the present study, we directly test these predictions.  In Experiment 1, we conceptually replicate previous findings that adults try to avoid semantic redundancy in conversation by adjusting information that is in common ground between speakers.  We also show that \red{something about when common ground is aligned}.  In Experiment 2, we show that \red{the strength of the backfiring effect varies according to the strength of the redundant preexisting beliefs.  Do we need something about observation?}.
