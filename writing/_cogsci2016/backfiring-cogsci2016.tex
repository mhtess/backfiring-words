...
We first analyze the data, separately, in terms of the proportion of participants who selected the more \emph{likely} option given an observation (e.g. the roommate who \emph{always} does her dishes) and the confidence ratings. 
...
Critically, participants were significantly \emph{less} likely to choose the ``likely''� option in the Misaligned Common Ground condition (M=0.46) than in the Prior condition (M=0.71) , $\beta = -1.42; SE = 0.15; p < .001$.  
Participants were no \emph{more} likely to choose the ``likely'' option in either the observation (M=0.71) or aligned CG (M=0.68) conditions as compared to the Prior.
