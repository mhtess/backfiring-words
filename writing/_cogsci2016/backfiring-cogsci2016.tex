...
Children and adults rely on both observation and input from others to learn about the world.  Children as young as X, for instance, are remarkably adept at using visual statistical information to identify other people's preferences (CITE), predict future events (CITE), and infer the characteristics of a population (CITE).  If a person randomly draws five red balls out of a bucket, then a child will infer that the bucket must contain mostly red balls.  Similarly, 
