...
A few studies, however, provide preliminary evidence that utterances can imply that the opposite of what is expressed is typically true when they are redundant with the listener's prior beliefs.
...
The headline, ``Girls can do math'', for instance, could potentially signal to a naive readers that many people believe that girls \emph{cannot} do math, and that there are legitimate reasons to hold this belief (e.g., perhaps girls tend to be less intelligent than boys).  
As a result, these readers might walk away doubting girls' ability to do math more than they would have otherwise.

Understanding how we process potentially uninformative utterances is therefore important not only for developing theories of language, but also for effectively promoting social change.
