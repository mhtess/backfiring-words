...
The prior probability of a behavior depends on the habits of the person. For demonstrative purposes, we assume that if the habit $h$ is present, the behavior has a high probability of occurring; if the habit is absent, the probability is lower. 
\begin{eqnarray}
...
%
\section{Experiment 2: Degrees of backfiring} \red{and model fit?}
