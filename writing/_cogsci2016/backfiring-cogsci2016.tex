...
cause adults to have a more negative impression of the target (here, Mr. Talbert) than they would otherwise \cite{Wegner1981}, and can actually cause people to believe the exact opposite of what those headlines claim \cite{Gruenfeld1992}.
...
\red{ - misunderstandings don't have to result in conversation breaking down - instead, adults readily accommodate each other, or infer the information that should be in common ground for the utterance to make sense}

\red{- this process ultimately makes presupposition extremely powerful - the information is implicitly communicated, and the listener is encouraged to accept a world in which the utterance is cooperative.  several studies - loftus and palmer, etc. - have demonstrated the remarkable power of presupposition.  THUS, this work has plenty of practical relevance, and should be considered by people trying to convince society to change their mind about something...}
