...
A few studies, however, provide preliminary evidence that when utterances are redundant with a listener's preexisting beliefs, they can imply that the opposite of what is expressed is typically true.
...
Why, exactly, do claims like these backfire, while others don't?  We suggest that this effect depends on the common ground established between the speaker and listener.  Critically, communication is successful only when the speaker and listener share common ground \cite{Clark1996}.  Although interlocutors often directly manage information that is in common ground by expressing lack of understanding, they can also use the conversational principle that utterances should be both relevant and informative \cite{Grice1975} to infer the knowledge that a speaker is presupposing in a given utterance.
