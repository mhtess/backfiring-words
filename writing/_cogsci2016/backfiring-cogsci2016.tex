...
In our first experiment, we tested the qualitative predictions of our pragmatic models that:
	...
	2. Backfiring should \emph{not} occur in conversational contexts in which a listener makes it clear that she is uncertain about a habit (e.g., when the listener explicitly asks the speaker if the student turned in his homework); and
