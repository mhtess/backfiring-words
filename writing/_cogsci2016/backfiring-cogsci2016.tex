...
In the Backfiring condition, participants read a series of 27 utterances from conversations describing actions of various people (e.g., ``Kelly wore socks today.").  After reading each utterance, participants were asked to indicate how frequently they believe the subject of the utterance engages in the activity (e.g.,``How often does Kelly wear socks?").
