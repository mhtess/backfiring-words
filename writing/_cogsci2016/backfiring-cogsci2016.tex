...
Our experiments serve as conceptual replications of previous work (CITE) demonstrating that semantically uninformative utterances can backfire (i.e., imply that the opposite is typically true).  We have also made the following novel contributions to our understanding of this effect:

	1. We have shown that backfiring depends critically on [insert].  When uncertainty about information in common ground is expressed, or when...
