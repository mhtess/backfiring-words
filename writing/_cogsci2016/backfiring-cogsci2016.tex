...
Only in the communicative condition do the inferred rates drop below the prior. 
...
To get a better idea for the reliability of this effect with our items, we compare the rate implied the utterance in a communicative context to the rate implied in the observational context, as a function of the baseline rate.
%
...
The fact that the effect in our data is small is likely driven by the fact that we have few items in the critical region where we expect backfiring to occur. 
